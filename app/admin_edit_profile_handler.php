...
require '../service/user_validation_service.php';
	...
	if(isset($_POST['update']))
 {
      ...
      $unameErr=usernameVerify($_POST['uname']);      	
		...
		{
			echo "<script>document.location='admin_profile.php?msgname=$nameErr & msguname=$unameErr & msgemail=$emailErr & msgpass=$passErr &  msgmob=$mobileErrr  & msgimage=$imageErr ';</script>";
		}
